...
import { FileInput, Image, Download, Folder, Layers, Film } from "lucide-react";
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{renderSteps}</span>
              </div>
              <Slider
                id="render-steps"
                value={[renderSteps]}
                onValueChange={([value]) => setRenderSteps(value)}
                min={1}
